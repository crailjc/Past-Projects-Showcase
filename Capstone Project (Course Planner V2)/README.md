...
# Templates
To faciliate your planning and collaboration, issue and merge request templates have been provided for your use.  Revise the existing md files in those folder, make new ones or delete the existing ones to suit the needs of your project and team.  

File locations: _Project_/Repository/.gitlab

![](https://drive.google.com/uc?export=view&id=1e_tms9iUBRVWR4FjXTj60rduFSRQzHGY)

Then, when you create a new issue or merge request, you'll see the option on the Description dropdown.  
